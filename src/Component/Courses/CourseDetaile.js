            ...
            <div className="flex flex-col-reverse items-center   gap-8">
                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    ...
                    <div className=" flex flex-row justify-between  mt-5">
                        ...
                        <p className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-700 hover:underline hover:text-gray-800 duration-100 cursor-pointer">{Duration}</p>
                    </div>
